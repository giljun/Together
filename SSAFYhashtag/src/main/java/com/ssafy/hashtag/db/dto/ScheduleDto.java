...
public class ScheduleDto {
    ...
    public ScheduleDto(int schedule_pk, int user_id, int post_id, String schedule_title, String schedule_image,
            String start_date, String end_date, String created_at, String updated_at) {
        super();
    ...
    public String getSchedule_title(String schedule_title) {
    ...
    public String getSchedule_image(String schedule_image) {
    ...
    public String toString() {
        return "ScheduleDto [schedule_pk=" + schedule_pk + ", user_id=" + user_id + ", post_id=" + post_id +
                ", schedule_title=" + schedule_title + ", schedule_image=" + schedule_image
